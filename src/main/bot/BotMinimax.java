...
//        if (depth == 0 || board.getGrille().isFull()) {
...
//                char boule = board.getGrille().getEmplacement(new Coordonnees(x, y));
...
//                if (x >= 0 && x < board.getGrille().getTaille() && y >= 0 && y < board.getGrille().getTaille() &&
//                        board.getGrille().getEmplacement(new Coordonnees(x, y)) == color.getColorChar()) {
//                    consecutive++;
//                } else {
//                    break;
//                }
